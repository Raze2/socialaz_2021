  ...
  data() {
    return {
      sidebarLinks: [
        ...
        {
          title: 'cruds.post.title',
          icon: 'table_view',
          path: { name: 'posts.index' },
          gate: 'post_access'
        },
        {
        ...
        {
          title: 'cruds.like.title',
          icon: 'table_view',
          path: { name: 'likes.index' },
          gate: 'like_access'
        },
        {
          title: 'cruds.userFriend.title',
          icon: 'table_view',
          path: { name: 'user_friends.index' },
          gate: 'user_friend_access'
        }
      ]
    }
  }
